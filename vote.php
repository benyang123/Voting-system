...
<body>
   <div>
      ...
      <div style="float:left;margin-left:40px;">
         <img src="img/strawberry.jpg" class="img-circle" alt="Cinque Terre" width="200" height="200"><br/><br/>
         <table>
            <td>
      ...
      <div style="float:left;margin-left:40px;">
         <img src="img/chocolate.jpg" class="img-circle" alt="Cinque Terre" width="200" height="200"><br/><br/>
         <table>
            <td>
               <tr><form class="form-inline" action="voteHandle.php" method="post">
      ...
      <div style="float:left;margin-left:40px;">
         <img src="img/puremilk.jpg" class="img-circle" alt="Cinque Terre" width="200" height="200"><br/><br/>
         <table>
            <td>
               <tr><form class="form-inline" action="voteHandle.php" method="post">
      ...
      <div style="float:left;margin-left:40px;">
         <img src="img/banana.jpg" class="img-circle" alt="Cinque Terre" width="200" height="200"><br/><br/>
         <table>
            <td>
               <tr><form class="form-inline" action="voteHandle.php" method="post">
